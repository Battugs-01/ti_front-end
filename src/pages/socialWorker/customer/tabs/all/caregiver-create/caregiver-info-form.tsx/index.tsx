...
export const CaregiverInfoForm: React.FC<FormType> = ({
  form,
  registerNumber,
}) => {
  ...
  useEffect(() => {
    form?.setFieldValue("rd", registerNumber?.rd);
  }, [registerNumber]);
              ...
              <Row gutter={[16, 16]}>
                <Col sm={8} xs={21}>
                  <ProFormText
                    ...
                    initialValue={registerNumber?.rd}
                    rules={
                      (FORM_ITEM_RULE(),
                      [
                        {
              ...
              <Row gutter={[16, 16]}>
                <Col sm={24} xs={21}>
                  <ProFormTextArea
                    name="reason"
                    placeholder={
                      "Асруулах болсон шалтгааныг дэлгэрэнгүй бичнэ үү."
                    }
