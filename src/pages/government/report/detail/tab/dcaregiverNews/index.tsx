    ...
    <Card>
      <div className="mt-4">
        <InitTableHeader
          hideCreate
          refresh={() => {}}
          customHeaderTitle="Төрөлжсөн асрамжийн үйл ажиллагаа эрхэлдэг аж ахуйн нэгж, байгууллагад нас барсан асруулагчийн мэдээ"
          toolbarItems={
            <div className="flex">
              <ExportButton
                onClick={() => {
